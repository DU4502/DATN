...
class ScheduledDeliveryTest extends TestCase
{
    public function test_delivery_schedule_reserves_payment_and_operation_time(): void
    {
        ...
        $this->assertNotNull(ScheduledDelivery::validate('2026-07-08 10:14:00', 'delivery'));
        $this->assertNull(ScheduledDelivery::validate('2026-07-08 10:15:00', 'delivery'));
    ...
    public function test_schedule_must_be_inside_opening_hours(): void
    {
        ...
        $this->assertNull(ScheduledDelivery::validate('2026-07-08 07:15:00', 'delivery'));
    ...
    {
        Carbon::setTestNow('2026-07-08 09:00:00');
        $this->assertNull(ScheduledDelivery::validate('2026-07-08 10:15:00'));
        $this->assertSame(
    ...
    public function test_scheduled_delivery_can_start_operation_in_the_last_sixty_minutes(): void
    {
        Carbon::setTestNow('2026-07-08 08:59:00');
        $order = new Order([
