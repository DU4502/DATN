<style>
    ...
    .group-chat-panel { position: fixed; right: 28px; bottom: 170px; z-index: 1055; width: min(390px, calc(100vw - 32px)); overflow: hidden; border: 0 !important; border-radius: 22px !important; box-shadow: 0 22px 60px rgba(31,38,90,.25); }
    ...
    @media (max-width: 575.98px) {
        ...
        .group-chat-panel { right: 16px; bottom: 158px; }
    }
