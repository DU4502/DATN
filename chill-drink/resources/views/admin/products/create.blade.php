                ...
                <div class="form-card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select rounded-3 @error('serving_temperature') is-invalid @enderror"
                            ...
                            <option value="" @selected(old('serving_temperature') === null || old('serving_temperature') === '')>-- Chưa thiết lập --</option>
                            <option value="hot" @selected(old('serving_temperature') === 'hot')>Nóng</option>
                            <option value="cold" @selected(old('serving_temperature') === 'cold')>Lạnh</option>
                            <option value="both" @selected(old('serving_temperature') === 'both')>Cả nóng và lạnh</option>
                        </select>
