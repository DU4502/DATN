...
<div class="location-picker" data-location-picker="{{ $pickerId }}" data-default-lat="{{ $defaultLat }}" data-default-lng="{{ $defaultLng }}" data-default-zoom="{{ $defaultZoom }}" data-initial-lat="{{ $latValue }}" data-initial-lng="{{ $lngValue }}" @if($autoFillAreaTarget) data-auto-fill-area-target="{{ $autoFillAreaTarget }}" @endif @if($autoFillStreetTarget) data-auto-fill-street-target="{{ $autoFillStreetTarget }}" @endif>
