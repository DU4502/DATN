...
<div class="row g-4 mb-5">
    ...
    <div class="col-md-6 col-xl-3">
        <div class="stat-card" tabindex="0" role="button" aria-label="Xem doanh thu theo kỳ">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <div class="stat-icon success"><i class="bi bi-bar-chart-fill"></i></div>
            </div>
            <div class="stat-label">Doanh thu {{ $selectedPeriodStat['label'] ?? 'kỳ này' }}</div>
            <div class="stat-value">{{ number_format($selectedPeriodStat['revenue'] ?? 0, 0, ',', '.') }}đ</div>
            <div class="text-secondary small">Dựa trên kỳ đã chọn</div>
        </div>
    </div>
