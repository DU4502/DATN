    ...
    <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" method="POST" action="{{ route('shipper.orders.issue', $order->id) }}">
            ...
            <div class="modal-body">
                <div class="alert alert-warning small" id="issueFlowNotice"><strong>Không có hủy/từ chối chuyến.</strong> Đơn không bị hủy; Admin hoặc Super Admin sẽ quyết định cách xử lý.</div>
