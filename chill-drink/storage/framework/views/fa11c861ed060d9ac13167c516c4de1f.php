...
<body>
        ...
        <aside class="root-sidebar" data-root-sidebar>
            ...
            <nav class="root-nav">
                ...
                <a href="<?php echo e(route('admin.chat.index')); ?>" class="root-nav-link <?php echo e(request()->routeIs('admin.chat.*') ? 'active' : ''); ?>">
                    ...
                    ?>
                    <span id="sidebar-chat-badge" class="badge rounded-pill bg-danger ms-auto" style="font-size: 0.72rem;<?php echo e($unreadChatMessages > 0 ? '' : 'display:none;'); ?>"><?php echo e($unreadChatMessages > 99 ? '99+' : $unreadChatMessages); ?></span>
                </a>
                ...
                <a href="<?php echo e(route('admin.super-admin')); ?>#health" class="root-nav-link" data-root-section="health"><i class="bi bi-activity"></i> Hệ thống</a>
            </nav>
    ...
    <script>
        ...
        const superAdminPath = '<?php echo e(parse_url(route("admin.super-admin"), PHP_URL_PATH)); ?>';
