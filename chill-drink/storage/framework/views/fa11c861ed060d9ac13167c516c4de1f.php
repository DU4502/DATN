...
<body>
    <div class="root-shell">
        <aside class="root-sidebar" data-root-sidebar>
            ...
            <nav class="root-nav">
                ...
                <a href="<?php echo e(route('admin.super-admin') . '#branch-ranking'); ?>" class="root-nav-link" data-root-section="branch-ranking"><i class="bi bi-shop"></i> Chi nhánh</a>
                <a href="<?php echo e(route('admin.super-admin') . '#admins'); ?>" class="root-nav-link" data-root-section="admins"><i class="bi bi-person-badge"></i> Quản trị viên</a>
    ...
    <script>
        ...
        (function () {
            ...
            const unreadUrl = '<?php echo e(route('admin.chat.unread-count')); ?>';
